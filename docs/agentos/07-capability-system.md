...
Capabilities are provider-independent contracts. Implementations bind a capability to a driver, prompt profile, evaluator config, and runtime. Providers sit behind drivers as interchangeable devices.
