...
Prefer PostgreSQL relational schemas for campaigns, capabilities, implementations, artifacts, evaluations, receipts, budget ledger, reservations, credentials, and events. Use pgvector selectively.
