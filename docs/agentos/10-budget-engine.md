...
The budget engine performs atomic reservations before execution and reconciles actual spend after provider/driver calls. It tracks Cost of Quality and Expected User Value per Dollar.
