...
Guarantees: idempotent mutation, atomic budget reservation, optimistic concurrency where appropriate, immutable receipts, outbox delivery, circuit breakers, health checks, and replayable artifacts.
