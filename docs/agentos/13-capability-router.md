...
The router optimizes Expected User Value per Dollar under constraints, budget, quality threshold, credential availability, and benchmarked implementation performance.
