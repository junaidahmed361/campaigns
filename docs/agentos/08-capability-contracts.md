...
Capability contracts define requires, produces, evaluators, artifact schemas, and acceptance metrics. They are the plugin API. Do not expose provider-specific APIs upward.
