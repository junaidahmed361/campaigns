...
OpenTelemetry traces, structured logs, metrics, spend ledger, evaluator scores, repair attempts, CoQ deltas, and EUV/$ routing rationale make decisions explainable.
