...
Phase 0: architecture repo, kernel contracts, evaluator, artifacts, receipts, budgets, credential plane stubs, router objective, client facades. Later: product dashboard, robust drivers, benchmark corpus.
