...
Credential Plane resolves BYOK, platform, and ephemeral credentials. Drivers receive scoped handles, never raw user secrets from clients or chat transcripts.
