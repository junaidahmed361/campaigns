...
Use structured relational records first. Embed only knowledge that requires semantic retrieval. Campaign state, decisions, artifacts, receipts, and evaluations are not chat memory.
